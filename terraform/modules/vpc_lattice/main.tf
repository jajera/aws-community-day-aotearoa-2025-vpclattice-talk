...
module "vpc_lattice" {
  source = "tfstack/vpc-lattice/aws"

  create_service_network = true
  service_network = {
    name      = "${var.name_prefix}1-network"
    auth_type = "AWS_IAM"
  ...
  vpc_associations = [
    ...
    },
    {
      ...
      security_group_ids = [
        var.security_group_ids["vpc_lattice_2_sg"]
      ]
      tags = {
        Environment = "dev"
        VPC         = "app_1"
    ...
    },
    {
      ...
      security_group_ids = [
        var.security_group_ids["vpc_lattice_3_sg"]
      ]
      tags = {
        Environment = "dev"
        VPC         = "app_2"
      ...
      target_groups = [
        {
          ...
          targets = [
            {
              target_id = var.lambda_arns["orders_service"]
            }
          ]
          tags = {
            Service = "orders"
        ...
        },
        {
          ...
          targets = [
            {
              target_id = var.lambda_arns["payments_service"]
            }
          ]
          tags = {
            Service = "payments"
        ...
        },
        {
          ...
          targets = [
            {
              target_id = var.lambda_arns["inventory_service"]
            }
          ]
          tags = {
            Service = "inventory"
        ...
        },
        {
          ...
          targets = [
            {
              target_id = var.analytics_service_alb_arn
              port      = 8000
            }
          ]
          health_check = {
        ...
        },
        {
          ...
          targets = [
            {
              target_id = var.ec2_notifications_service_instance_id
              port      = 80
            }
          ]
          health_check = {
        ...
        },
        {
          ...
          targets = [
            {
              target_id = var.lambda_arns["notfound_service"]
            }
          ]
          tags = {
            Service = "notfound"
      ...
      target_groups = [
        {
          ...
          targets = [
            {
              target_id = var.lambda_arns["products_service"]
            }
          ]
          tags = {
            Service = "products-v1"
        ...
        },
        {
          ...
          targets = [
            {
              target_id = var.lambda_arns["products_service_v2"]
            }
          ]
          tags = {
            Service = "products-v2"
  ...
  log_group_name            = "/aws/vpclattice/${var.name_prefix}"
